      ...
      <div className="chat-header">
        ...
        >
          <img
            ...
            width={14}
            height={11}
            className="chat-ai-back-icon"
          />
        </button>
        <button
          type="button"
          className="chat-ai-add-btn chat-thread-add-btn"
            ...
            <div className="chat-composer-pending-images">
              {pendingAttachmentPreviews.map((p) => (
                <div key={p.id} className="chat-composer-pending-thumb-wrap">
                  <img
                    className="chat-composer-pending-thumb"
                    src={p.url}
                    alt=""
                  />
                  <button
          ...
          <textarea
            ...
            onKeyDown={(e) => {
              if (
                e.key === "Enter" &&
                !e.shiftKey &&
                (value.trim() || pendingAttachmentPreviews.length > 0)
              ) {
                e.preventDefault();
                onTypingSend();
              }
                ...
                >
                  ...
                  >
                    ...
                    <img
                      src={fileMenuIcon}
                      alt=""
                      className="chat-attach-menu-icon chat-attach-menu-icon--file"
                    />
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <img
                      src={cameraMenuIcon}
                      alt=""
                      className="chat-attach-menu-icon chat-attach-menu-icon--camera"
                    />
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <img
                      src={photoMenuIcon}
                      alt=""
                      className="chat-attach-menu-icon chat-attach-menu-icon--photo"
                    />
                  </button>
                </div>
              ) : null}
  ...
  return (
    <div className="ai-chat-chat-screen">
      <header className="chat-thread-header">
        <button
          type="button"
          className="chat-ai-back-btn chat-thread-back-btn"
          onClick={onBack}
          aria-label="Back"
        >
          <img
                ...
                m.imageUrls?.length ? (
                  ...
                  <div className="chat-msg-user-row">
                    <div className="chat-msg-user-bubble">
                      <p className="chat-msg-user-text">
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Bring your friends along, splitting bills
              <br />
          ...
          >
            <span style={{ color: "#6A59CE", fontSize: "12px" }}>
              https://manee.34
            </span>
            <button
              type="button"
            ...
            >
              <img
                src="/assets/icons/actions/clipboard-purple.svg"
                alt="Copy"
        ...
        <div className="phone-frame" ref={phoneFrameRef}>
          ...
          >
            <div className="ai-chat-root" ref={aiChatRootRef}>
              <div className="ai-chat-layout-fill">{renderMain()}</div>
