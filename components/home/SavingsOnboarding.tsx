...
const onboardingData = [
  {
    ...
    title: "Loans",
    description:
      "Grow your credit score and get loans up to GHS 16,000 with easy, flexible repayment.",
    color: "bg-[#BBE6C3]",
  },
  {
    image: "#",
    ...
    description:
      "Become a 3rike owner with just GHS 600 and start earning weekly.",
    color: "bg-[#7BCD8A]",
  },
];
...
export default function SavingsOnboarding() {
  ...
  const handleDashboard = () => {
    router.push("/driver/savings/dashboard");
  };

  return (
    <div className="fixed inset-0 bg-white flex flex-col p-3 overflow-y-auto">
      <div className="relative flex items-center pt-10 p-6">
        ...
        {/* Centered title */}
        <p className="mx-auto font-medium text-md text-center">Savings</p>
      </div>
      {/* Image Section */}
      <div
        className={`relative w-full h-115.5 rounded-4xl ${screenData.color} mb-6`}
      >
        <img
      ...
      <div className="absolute bottom-0 right-25 -translate-x-1/2">
        ...
        <div className="absolute bottom-0 left-8 -translate-x-1/2 mb-10">
          <Button
            ...
            className="w-auto py-6 rounded-md text-[#01C259]  font-light text-lg shadow-none flex items-center gap-0.5"
          >
