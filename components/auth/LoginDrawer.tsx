...
/**
 * "I have an existing wallet" opens a bottom sheet: email, Continue, Google, or secret phrase import.
 */
export default function LoginDrawer() {
  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      >
        <DrawerTitle className="sr-only">Access your wallet</DrawerTitle>
        ...
        <div className="relative flex h-full min-h-0 flex-col overflow-hidden px-6 pb-4">
          ...
          <div className="flex min-h-0 flex-1 w-full max-w-[342px] flex-col self-center pt-[80px]">
            <label className="sr-only" htmlFor="login-wallet-email">
              Email address
            </label>
            <input
              id="login-wallet-email"
              type="email"
              inputMode="email"
              autoComplete="email"
